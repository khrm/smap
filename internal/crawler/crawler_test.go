...
func TestNewConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewConfig(tt.args.r, tt.args.d, tt.args.debug); !reflect.DeepEqual(got, tt.want) {
...
func TestNew(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := New(tt.args.r, tt.args.p, tt.args.l, nil); !reflect.DeepEqual(got, tt.want) {
...
func Test_service_Start(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			sm := s.Start()
			if !reflect.DeepEqual(tt.want, sm) {
				t.Errorf("\nNew() = %v, \n want  = %v", s.sm, tt.want)
			}
		})
	}
